...
create_constraint_mode -name constraint_default\
   -sdc_files\
    [list ${::IMEX::dataVar}/mmmc/modes/constraint_default/constraint_default.sdc]
create_analysis_view -name typView -constraint_mode constraint_default -delay_corner typDC -latency_file ${::IMEX::dataVar}/mmmc/views/typView/latency.sdc
